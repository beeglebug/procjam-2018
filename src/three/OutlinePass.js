...
import {
  ...
  Color,
  DoubleSide,
  LinearFilter, Matrix4, Mesh,
  MeshBasicMaterial,
  MeshDepthMaterial, NoBlending, OrthographicCamera, PlaneBufferGeometry, RGBADepthPacking,
  RGBAFormat, Scene, ShaderMaterial, UniformsUtils,
  Vector2, Vector3,
  WebGLRenderTarget
} from 'three'
